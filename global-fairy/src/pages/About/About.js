  ...
  return (
    <div className={style.aboutContainer}>
      <Helmet>
        ...
        <meta
          name="description"
          content="Show for you our story and why us"
        ></meta>
      ...
      <div className={style.container}>
        <div className={style.text}>
          ...
          <p className={style.phrase1}>
            Launched over 7 years ago in Lebanon, Exclusive has swiftly grown
            into a leading multi-vendor marketplace. Focused on women aged 18
            and above, we offer a diverse range of fashion and makeup brands for
            a convenient shopping experience. Our goal is to save customers time
            and effort while providing extensive product options.{" "}
          </p>
          <p>
            Exclusive strives to be a trusted online shopping destination,
            fostering brand visibility and sales for vendors while cultivating a
            loyal customer base. With 7+ years of expertise, we continue to set
            new standards in Lebanon's bustling e-commerce landscape.{" "}
          </p>
        </div>
