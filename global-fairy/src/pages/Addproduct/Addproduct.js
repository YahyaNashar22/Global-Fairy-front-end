    ...
    <div>
      ...
      >
        <div className={style.row1}>
          ...
          <div className={style.labelInput}>
            <label className={style.labelForm} for="brand">
              Brand:
            </label>
            <br />
          ...
          <div className={style.labelInput}>
            <label className={style.labelForm} for="category">
              Category:
            </label>
            <br />
            <select
          ...
          <div className={style.labelInput}>
            <label className={style.labelForm} for="subcategory">
              Sub-Category:
            </label>
            <br />
            <select
        ...
        <div className={style.row2}>
          <div className={style.labelInput}>
            <label className={style.labelForm} for="price">
              Price:
            </label>
            <br />
            <input
          ...
          <div className={style.labelInput}>
            <label className={style.labelForm} for="images">
              Images:
            </label>
            <br />
            <input
        ...
        <div className={style.labelInput}>
          <label className={style.labelForm} for="description">
            Description:
          </label>
          <br />
          <input
            className={style.desrciptionInputs}
            type="text"
            id="description"
            name="description"
          />
        ...
        <div className={style.row3}>
          <fieldset className={style.fieldsetForm}>
            ...
            <div className={style.labelInput}>
              <label className={style.labelForm} for="color">
                Color:
              </label>
              <br />
              <input
            ...
            <div className={style.labelInput}>
              <label className={style.labelForm} for="quantity">
                Quantity:
              </label>
              <br />
              <input
            ...
            <div className={style.labelInput}>
              <label className={style.labelForm}>Size:</label>
              <br />
